...
vim.api.nvim_create_autocmd("BufWritePre", {
	group = vim.api.nvim_create_augroup("RemoveTrailingWhitespace", { clear = false }),
	pattern = { "*" },
	callback = function()
...
vim.api.nvim_create_autocmd("FileType", {
	group = vim.api.nvim_create_augroup("SetupTabsListFold", { clear = false }),
	pattern = { "markdown" },
	callback = function()
		vim.wo.list = false
	end,
...
vim.api.nvim_create_autocmd("FileType", {
	group = vim.api.nvim_create_augroup("SetupTabsListFold", { clear = false }),
	pattern = { "vim,xml,html,yaml,dockerfile" },
	callback = function()
		vim.bo.tabstop = 2
...
local ft_au_group = vim.api.nvim_create_augroup("FileTemplate", { clear = false })
